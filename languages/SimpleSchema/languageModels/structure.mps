...
<model modelUID="r:6b361b0c-2741-46c0-8b66-2d76e33af5ab(SimpleSchema.structure)" version="1">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="6264960030857864903" nodeInfo="ig">
    ...
    <node role="implements" roleId="tpce.1169129564478" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="8519667119007942673" nodeInfo="ig">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="8519667119007931912" nodeInfo="ig">
    ...
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="8519667119007931994" nodeInfo="ig">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="8519667119007963441" nodeInfo="ig">
      <property name="metaClass" nameId="tpce.1071599937831" value="aggregation" />
  ...
  <root type="tpce.InterfaceConceptDeclaration" typeId="tpce.1169125989551" id="8519667119007963339" nodeInfo="ig">
    ...
    <node role="extends" roleId="tpce.1169127546356" type="tpce.InterfaceConceptReference" typeId="tpce.1169127622168" id="8519667119007963397" nodeInfo="ig">
      <link role="intfc" roleId="tpce.1169127628841" targetNodeId="tpck.1169194658468" resolveInfo="INamedConcept" />
    </node>
  </root>
