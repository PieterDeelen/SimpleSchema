...
public class ComplexType_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1xbd1d_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_1xbd1d_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createCollection_1xbd1d_b0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(this.createIndentCell_1xbd1d_a1a(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_1xbd1d_b1a(editorContext, node));
    return editorCell;
  }

  private EditorCell createIndentCell_1xbd1d_a1a(EditorContext editorContext, SNode node) {
    EditorCell_Indent editorCell = new EditorCell_Indent(editorContext, node);
    return editorCell;
  }

  private EditorCell createRefNodeList_1xbd1d_b1a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new ComplexType_Editor.elementsListHandler_1xbd1d_b1a(node, "elements", editorContext);
  ...
  private static class elementsListHandler_1xbd1d_b1a extends RefNodeListHandler {
    public elementsListHandler_1xbd1d_b1a(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_1xbd1d_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "}");
    editorCell.setCellId("Constant_1xbd1d_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
}
